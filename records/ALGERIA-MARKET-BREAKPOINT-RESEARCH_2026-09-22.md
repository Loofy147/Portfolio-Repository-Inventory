...
For every candidate transaction:
1. Identify the actual trigger/event.
2. Identify who currently performs the work.
3. Pre-kill commoditized, internalized, regulated, or low-value work.
4. Identify the cross-boundary breakpoint.
5. Identify the economic consequence.
6. Identify the artifact/evidence produced.
7. Identify the accepting party.
8. Identify the legal or contractual recognition path.
...
- Authorities check concordance between the declared product and the commercial-activity code.
- Control can be documentary, visual, and analytical where necessary.
- Bank of Algeria Note 01/DGC/2026 requires prior bank domiciliation before shipment and checks shipment dates against domiciliation.

Potential transaction:
Technical consistency preflight before shipment/arrival.
